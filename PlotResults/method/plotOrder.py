...
ax = plt.subplot(111)
plt.plot(b_path0[1:,0], b_headings, 'b-', label="Beharivor")
...
# pp.set_edgecolor("k")
plt.savefig("/home/duynam/MPC_formation_changing/PlotResults/results/behavior_order.pdf", format="pdf", bbox_inches="tight")
plt.show()